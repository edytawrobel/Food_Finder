...
class Guide
  ...
  def list(args=[])
    ...
    sort_order = "name" unless ['name', 'cuisine', 'price'].include?(sort_order) #setting default if sort not dictated by user
    ...
    puts "Sort using: 'list cuisine' or 'list by cusine\n\n'"
  end
